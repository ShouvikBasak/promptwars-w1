...
Vibe coding is everywhere right now. And it is efficient for quick prototyping and exploration.

Fast feedback, creative flow, momentum.
...
This post is the first in a series, where I will share my experience with agentic development using Google Antigravity.
